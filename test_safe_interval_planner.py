...
def test_safe_interval_planner():
    ...
    safe_interval_table.add_node_constraint((1, 0, 0), start_time=0.0, end_time=2.0)
    safe_interval_table.add_node_constraint((0, 1, 0), start_time=0.0, end_time=2.0)
    safe_interval_table.add_node_constraint((0, 0, 1), start_time=0.0, end_time=12.0)
    safe_interval_table.add_node_constraint((2, 0, 0), start_time=0.0, end_time=5.0)
